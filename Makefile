#############################################################################
# Makefile for building: mastermold-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: mar. 5. mai 06:39:10 2015
# Project:  mastermold-qt.pro
# Template: app
# Command: c:/Qt/4.8.6/bin/qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile mastermold-qt.pro
#############################################################################
...
Makefile: mastermold-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile mastermold-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/mastermold-master/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/mastermold-master/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/mastermold-master/src/leveldb/libleveldb.a: FORCE
	cd C:/mastermold-master/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && ranlib C:/mastermold-master/src/leveldb/libleveldb.a && ranlib C:/mastermold-master/src/leveldb/libmemenv.a
