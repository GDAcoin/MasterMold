...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        RPCConsole->resize(740, 490);
        RPCConsole->setStyleSheet(QString::fromUtf8(""));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "MasterMold - Debug window", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("RPCConsole", "MasterMold Core", 0, QApplication::UnicodeUTF8));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the MasterMold debug log file from the current data directory. This can take a few seconds for large log files.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the MasterMold-Qt help message to get a list with possible MasterMold command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
